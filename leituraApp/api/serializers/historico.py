...
from api.models.historico import Historico, HistoricoMeta, HistoricoLeitura


class HistoricoLeituraSerializer(serializers.ModelSerializer):
    # specify model and fields
    class Meta:
        model = HistoricoLeitura  # Substitua 'Historico' pelo nome do seu modelo
        fields = '__all__'
